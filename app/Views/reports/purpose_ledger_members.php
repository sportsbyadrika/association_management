    ...
    <div class="overflow-x-auto">
        <table class="table">
            <thead><tr>
                ...
                <th class="text-right">Total Dues</th><th class="text-right">Collected</th><th class="text-right">Balance</th>
                <th>Last Received</th>
            </tr></thead>
            <tbody>
            ...
            <?php endforeach; ?>
            <?php if ($rows === []): ?>
                <tr><td colspan="7" class="text-center text-gray-400 py-8">No dues for this project.</td></tr>
            <?php endif; ?>
            </tbody>
            <?php if ($rows !== []): ?>
            <tfoot>
