...
<div class="grid gap-6 lg:grid-cols-3">
    ...
    <div class="card card-body relative">
        <a href="<?= e(url('/members/' . $member['id'] . '/edit')) ?>"
           class="absolute right-3 top-3 inline-flex h-9 w-9 items-center justify-center rounded-full text-gray-400 transition hover:bg-gray-100 hover:text-brand-700"
           title="Edit member" aria-label="Edit member">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M15.232 5.232l3.536 3.536M4 20h4l10.5-10.5a2.5 2.5 0 00-3.536-3.536L4 16.5V20z"/>
            </svg>
        </a>
    ...
    <!-- Family members (to the right of member details) -->
    <div class="lg:col-span-2">
        <div class="card">
            ...
            <div class="overflow-x-auto">
                <table class="table">
                    <thead><tr><th class="w-16">Sl No.</th><th>Photo</th><th>Name</th><th>Type</th><th>Relation</th><th>Age</th><th>Gender</th><th>Mobile</th><th class="text-right">Actions</th></tr></thead>
                    <tbody>
                    ...
                    <?php if ($familyMembers === []): ?>
                        <tr><td colspan="9" class="text-center text-gray-400 py-8">No family members recorded yet.</td></tr>
                    <?php endif; ?>
                    </tbody>
                </table>
            </div>
...
<!-- Ledger: cards with actions, then the entries table -->
<div class="mt-8">
